...
namespace Avalonia.Aurora.Wayland
{
    internal class WlBitmapCursor : WlCursor, IFramebufferPlatformSurface
    {
        ...
        public WlBitmapCursor(AvaloniaAuroraWaylandPlatform platform, IBitmapImpl cursor, PixelPoint hotspot) : base(1)
        {
            _cursor = cursor;
            ...
            _wlBuffer = _wlShmPool.CreateBuffer(0, cursor.PixelSize.Width, cursor.PixelSize.Height, _stride, (uint)WlShm.FormatEnum.Argb8888);
