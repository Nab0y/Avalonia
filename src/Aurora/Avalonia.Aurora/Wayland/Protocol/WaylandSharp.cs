...
namespace WaylandSharp
{
    ...
    public unsafe partial class WlDisplay : WlClientObject
    {
        ...
        {
            CheckIfDisposed();
            return WlDisplayPrepareRead((_WlDisplay*)_proxyObject);
        }

        public int DispatchPending()
        {
            CheckIfDisposed();
            return WlDisplayDispatchPending((_WlDisplay*)_proxyObject);
        }

        public int Flush()
        {
            CheckIfDisposed();
            return WlDisplayFlush((_WlDisplay*)_proxyObject);
        }

        public void CancelRead()
        {
            CheckIfDisposed();
            WlDisplayCancelRead((_WlDisplay*)_proxyObject);
        }

        public int ReadEvents()
        {
            CheckIfDisposed();
            return WlDisplayReadEvents((_WlDisplay*)_proxyObject);
        }

        public int GetFd()
        {
            CheckIfDisposed();
            return WlDisplayGetFd((_WlDisplay*)_proxyObject);
        }
    }
    ...
    public unsafe partial class WlDisplay : WlClientObject
    {
        public WlDisplay(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlCallback(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlCompositor(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlShmPool(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlShm(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
        ...
        public class FormatEventArgs : EventArgs
        {
            ...
            public FormatEventArgs(uint format)
            {
                Format = format;
            }
        }
    ...
    {
        public WlBuffer(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlDataOffer(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlDataSource(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlDataDevice(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
            ...
            int dispatcher(void* data, void* target, uint callbackOpcode, _WlMessage* messageSignature, _WlArgument* args)
            {
                switch (callbackOpcode)
                {
                    ...
                    case 1:
                        ...
                        var enterArg2 = args[2].f.ToDouble(); //WlFixedToDouble(args[2].f);
                        var enterArg3 = args[3].f.ToDouble(); //WlFixedToDouble(args[3].f);
                    ...
                    case 3:
                        ...
                        var motionArg1 = args[1].f.ToDouble(); //WlFixedToDouble(args[1].f);
                        var motionArg2 = args[2].f.ToDouble(); //WlFixedToDouble(args[2].f);
        ...
        public void StartDrag(WlDataSource source, WlSurface origin, WlSurface? icon, uint serial)
        {
            ...
            var arg2 = icon == null ? null : icon._proxyObject;
            var arg3 = serial;
    ...
    {
        public WlDataDeviceManager(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlShell(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlShellSurface(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
        ...
        public class ConfigureEventArgs : EventArgs
        {
            ...
            public ConfigureEventArgs(uint edges, int width, int height)
            {
                Edges = edges;
                Width = width;
                Height = height;
    ...
    {
        public WlSurface(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
        ...
        {
            CheckIfDisposed();
            var arg0 = buffer == null ? null : buffer._proxyObject;
            var arg1 = x;
            var arg2 = y;
    ...
    {
        public WlSeat(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
        ...
        public class CapabilitiesEventArgs : EventArgs
        {
            ...
            public CapabilitiesEventArgs(uint capabilities)
            {
    ...
    {
        public WlPointer(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
        ...
        public class ButtonEventArgs : EventArgs
        {
            ...
            public ButtonEventArgs(uint serial, uint time, uint button, uint state)
            {
                Serial = serial;
                Time = time;
                Button = button;
        ...
        public class AxisEventArgs : EventArgs
        {
            ...
            public AxisEventArgs(uint time, uint axis, double value)
            {
                Time = time;
                Axis = axis;
                Value = value;
    ...
    {
        public WlKeyboard(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
        ...
        public class KeymapEventArgs : EventArgs
        {
            ...
            public KeymapEventArgs(uint format, int fd, uint size)
            {
                Format = format;
                Fd = fd;
                Size = size;
        ...
        public class KeyEventArgs : EventArgs
        {
            ...
            public KeyEventArgs(uint serial, uint time, uint key, uint state)
            {
                Serial = serial;
                Time = time;
                Key = key;
    ...
    {
        public WlTouch(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
            ...
            int dispatcher(void* data, void* target, uint callbackOpcode, _WlMessage* messageSignature, _WlArgument* args)
            {
                switch (callbackOpcode)
                {
                    case 0:
                        ...
                        var downArg4 = args[4].f.ToDouble(); //WlFixedToDouble(args[4].f);
                        var downArg5 = args[5].f.ToDouble(); //WlFixedToDouble(args[5].f);
                    ...
                    case 2:
                        ...
                        var motionArg2 = args[2].f.ToDouble(); //WlFixedToDouble(args[2].f);
                        var motionArg3 = args[3].f.ToDouble(); //WlFixedToDouble(args[3].f);
    ...
    {
        public WlOutput(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
        ...
        public class GeometryEventArgs : EventArgs
        {
            ...
            public int Subpixel { get; }
            public string Make { get; }
            public string Model { get; }
            public int Transform { get; }

            public GeometryEventArgs(int x, int y, int physical_width, int physical_height, int subpixel, string make, string model, int transform)
            {
                X = x;
                Y = y;
        ...
        public class ModeEventArgs : EventArgs
        {
            ...
            public ModeEventArgs(uint flags, int width, int height, int refresh)
            {
                Flags = flags;
                Width = width;
                Height = height;
    ...
    {
        public WlRegion(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlSubcompositor(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
    ...
    {
        public WlSubsurface(System.IntPtr proxyObject) : base((_WlProxy*)proxyObject)
        {
        }
...
#pragma warning disable CA5392
    internal static unsafe class Client
    {
        ...
        [DllImport(LibWaylandClient, EntryPoint = "wl_proxy_marshal_flags", ExactSpelling = true)]
        public static extern _WlProxy* WlProxyMarshalFlags(_WlProxy* proxy, uint opcode, _WlInterface* @interface, uint version, uint flags, _WlProxy* param0, IntPtr param1, int param2);
        [DllImport(LibWaylandClient, EntryPoint = "wl_proxy_marshal_flags", ExactSpelling = true)]
    ...
    public partial class WlInterface
    {
        ...
        static WlInterface()
        {
            ...
            WlOutput = new WlInterface.Builder("wl_output", 2).Event("geometry", "iiiiissi", new WlInterface? [] { null, null, null, null, null, null, null, null }).Event("mode", "uiii", new WlInterface? [] { null, null, null, null }).Event("done", "2", new WlInterface? [] { }).Event("scale", "2i", new WlInterface? [] { null });
            ...
            WlSurface = new WlInterface.Builder("wl_surface", 3).Event("enter", "o", new WlInterface? [] { WlOutput }).Event("leave", "o", new WlInterface? [] { WlOutput }).Method("destroy", "", new WlInterface? [] { }).Method("attach", "oii", new WlInterface? [] { WlBuffer, null, null }).Method("damage", "iiii", new WlInterface? [] { null, null, null, null }).Method("frame", "n", new WlInterface? [] { WlCallback }).Method("set_opaque_region", "o", new WlInterface? [] { WlRegion }).Method("set_input_region", "o", new WlInterface? [] { WlRegion }).Method("commit", "", new WlInterface? [] { }).Method("set_buffer_transform", "2i", new WlInterface? [] { null }).Method("set_buffer_scale", "3i", new WlInterface? [] { null });
            WlCompositor = new WlInterface.Builder("wl_compositor", 3).Method("create_surface", "n", new WlInterface? [] { WlSurface }).Method("create_region", "n", new WlInterface? [] { WlRegion });
            ...
            WlDataOffer = new WlInterface.Builder("wl_data_offer", 1).Event("offer", "s", new WlInterface? [] { null }).Method("accept", "us", new WlInterface? [] { null, null }).Method("receive", "sh", new WlInterface? [] { null, null }).Method("destroy", "", new WlInterface? [] { });
            WlDataSource = new WlInterface.Builder("wl_data_source", 1).Event("target", "s", new WlInterface? [] { null }).Event("send", "sh", new WlInterface? [] { null, null }).Event("cancelled", "", new WlInterface? [] { }).Method("offer", "s", new WlInterface? [] { null }).Method("destroy", "", new WlInterface? [] { });
            WlDataDevice = new WlInterface.Builder("wl_data_device", 2).Event("data_offer", "n", new WlInterface? [] { WlDataOffer }).Event("enter", "uoffo", new WlInterface? [] { null, WlSurface, null, null, WlDataOffer }).Event("leave", "", new WlInterface? [] { }).Event("motion", "uff", new WlInterface? [] { null, null, null }).Event("drop", "", new WlInterface? [] { }).Event("selection", "o", new WlInterface? [] { WlDataOffer }).Method("start_drag", "ooou", new WlInterface? [] { WlDataSource, WlSurface, WlSurface, null }).Method("set_selection", "ou", new WlInterface? [] { WlDataSource, null }).Method("release", "2", new WlInterface? [] { });
            WlPointer = new WlInterface.Builder("wl_pointer", 3).Event("enter", "uoff", new WlInterface? [] { null, WlSurface, null, null }).Event("leave", "uo", new WlInterface? [] { null, WlSurface }).Event("motion", "uff", new WlInterface? [] { null, null, null }).Event("button", "uuuu", new WlInterface? [] { null, null, null, null }).Event("axis", "uuf", new WlInterface? [] { null, null, null }).Method("set_cursor", "uoii", new WlInterface? [] { null, WlSurface, null, null }).Method("release", "3", new WlInterface? [] { });
            WlKeyboard = new WlInterface.Builder("wl_keyboard", 4).Event("keymap", "uhu", new WlInterface? [] { null, null, null }).Event("enter", "uoa", new WlInterface? [] { null, WlSurface, null }).Event("leave", "uo", new WlInterface? [] { null, WlSurface }).Event("key", "uuuu", new WlInterface? [] { null, null, null, null }).Event("modifiers", "uuuuu", new WlInterface? [] { null, null, null, null, null }).Event("repeat_info", "4ii", new WlInterface? [] { null, null }).Method("release", "3", new WlInterface? [] { });
            WlTouch = new WlInterface.Builder("wl_touch", 3).Event("down", "uuoiff", new WlInterface? [] { null, null, WlSurface, null, null, null }).Event("up", "uui", new WlInterface? [] { null, null, null }).Event("motion", "uiff", new WlInterface? [] { null, null, null, null }).Event("frame", "", new WlInterface? [] { }).Event("cancel", "", new WlInterface? [] { }).Method("release", "3", new WlInterface? [] { });
            WlSeat = new WlInterface.Builder("wl_seat", 4).Event("capabilities", "u", new WlInterface? [] { null }).Event("name", "2s", new WlInterface? [] { null }).Method("get_pointer", "n", new WlInterface? [] { WlPointer }).Method("get_keyboard", "n", new WlInterface? [] { WlKeyboard }).Method("get_touch", "n", new WlInterface? [] { WlTouch });
            WlDataDeviceManager = new WlInterface.Builder("wl_data_device_manager", 2).Method("create_data_source", "n", new WlInterface? [] { WlDataSource }).Method("get_data_device", "no", new WlInterface? [] { WlDataDevice, WlSeat });
